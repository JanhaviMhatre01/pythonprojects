'''
/**********************************************************************************
* Purpose: use a deque to store the characters of the string. We will process the string from left to right and add each character to
...
class Palindrome:
    def __init__(self):  # constructor for palindrome
        self.ele = "mayalayam"            # input string to check whether it is palindrome
